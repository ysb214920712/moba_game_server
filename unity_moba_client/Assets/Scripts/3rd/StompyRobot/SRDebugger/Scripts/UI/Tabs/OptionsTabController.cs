namespace SRDebugger.UI.Tabs
{
    ...
    public class OptionsTabController : SRMonoBehaviourEx
    {
        ...
        protected override void Start()
        {
            ...
            List<SRGameOptionStruct> list = SRGameOptions.GetSRGameOptionList();
            SRDebug.Instance.RemoveAllOptionContainer();
            SRDebug.Instance.AddOptionStructList(list);
        ...
        private void PanelOnVisibilityChanged(IDebugPanelService debugPanelService, bool b)
        {
            ...
            {
                List<SRGameOptionStruct> list = SRGameOptions.GetSRGameOptionList();
                bool hasNewOption = list.Count > 0;
                if (hasNewOption)
                {
                    SRDebug.Instance.RemoveAllOptionContainer();
                    SRDebug.Instance.AddOptionStructList(list);

namespace SRDebugger.UI.Controls.Data
{
    ...
    public class NumberControl : DataBoundControl
    {
        ...
        protected override void OnBind(string propertyName, Type t)
        {
            ...
            } else if (LuaReference != null)
            {
                NumberSpinner.MaxValue = Math.Min(LuaReference.GetMaxValue(), NumberSpinner.MaxValue);
                NumberSpinner.MinValue = Math.Max(LuaReference.GetMinValue(), NumberSpinner.MinValue);

                if (UpNumberButton != null)
                {
                    UpNumberButton.Amount = LuaReference.GetIncrement();
                }

                if (DownNumberButton != null)
                {
                    DownNumberButton.Amount = -LuaReference.GetIncrement();
                }
            }

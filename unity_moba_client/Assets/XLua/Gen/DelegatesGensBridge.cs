...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public bool __Gen_Delegate_Imp15(int p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public bool __Gen_Delegate_Imp16(int p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public XLua.LuaTable __Gen_Delegate_Imp17()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int[] __Gen_Delegate_Imp18()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp20(int p0, UnityEngine.Vector3 p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp21(int p0, string p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp22(float p0, uint p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp23(bool p0, UnityEngine.Texture2D p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp24(int p0, int p1, bool p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp25(UnityEngine.Object[] p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp26(UnityEngine.Vector2 p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp27(int p0, UnityEngine.Transform p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp28(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp29(object p0, int p1, int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UnityEngine.Vector3 __Gen_Delegate_Imp30(object p0, UnityEngine.Vector3 p1, UnityEngine.Vector3 p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp31(object p0, int p1, out double p2, ref string p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp32(object p0, int p1, out double p2, ref string p3, object p4)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp33(object p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public string __Gen_Delegate_Imp34(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UnityEngine.GameObject __Gen_Delegate_Imp35(XLuaTest.StructTest p0, int p1, object p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public string __Gen_Delegate_Imp36(XLuaTest.StructTest p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp37(XLuaTest.StructTest p0, object p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp39(object p0, object p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp40(object p0, object p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp42(int p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp43(object p0, int p1, int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Func<bool>(__Gen_Delegate_Imp14);
			}
		
		    if (type == typeof(System.Func<int, bool>))
			{
			    return new System.Func<int, bool>(__Gen_Delegate_Imp15);
			}
		
		    if (type == typeof(System.Func<int, int, bool>))
			{
			    return new System.Func<int, int, bool>(__Gen_Delegate_Imp16);
			}
		
		    if (type == typeof(System.Func<XLua.LuaTable>))
			{
			    return new System.Func<XLua.LuaTable>(__Gen_Delegate_Imp17);
			}
		
		    if (type == typeof(System.Func<int[]>))
			{
			    return new System.Func<int[]>(__Gen_Delegate_Imp18);
			}
		
		    if (type == typeof(System.Action<int>))
			{
			    return new System.Action<int>(__Gen_Delegate_Imp19);
			}
		
		    if (type == typeof(System.Action<int, UnityEngine.Vector3>))
			{
			    return new System.Action<int, UnityEngine.Vector3>(__Gen_Delegate_Imp20);
			}
		
		    if (type == typeof(System.Action<int, string>))
			{
			    return new System.Action<int, string>(__Gen_Delegate_Imp21);
			}
		
		    if (type == typeof(System.Action<float, uint>))
			{
			    return new System.Action<float, uint>(__Gen_Delegate_Imp22);
			}
		
		    if (type == typeof(System.Action<bool, UnityEngine.Texture2D>))
			{
			    return new System.Action<bool, UnityEngine.Texture2D>(__Gen_Delegate_Imp23);
			}
		
		    if (type == typeof(System.Action<int, int, bool>))
			{
			    return new System.Action<int, int, bool>(__Gen_Delegate_Imp24);
			}
		
		    if (type == typeof(System.Action<UnityEngine.Object[]>))
			{
			    return new System.Action<UnityEngine.Object[]>(__Gen_Delegate_Imp25);
			}
		
		    if (type == typeof(UnityEngine.Events.UnityAction<UnityEngine.Vector2>))
			{
			    return new UnityEngine.Events.UnityAction<UnityEngine.Vector2>(__Gen_Delegate_Imp26);
			}
		
		    if (type == typeof(System.Action<int, UnityEngine.Transform>))
			{
			    return new System.Action<int, UnityEngine.Transform>(__Gen_Delegate_Imp27);
			}

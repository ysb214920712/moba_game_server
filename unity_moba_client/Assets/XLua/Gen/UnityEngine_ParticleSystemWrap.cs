...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineParticleSystemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 13, 31, 3);
        ...
        static int _m_GetDuration(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)) 
                {
                    bool _allowLoop = LuaAPI.lua_toboolean(L, 2);
                    
                        var gen_ret = gen_to_be_invoked.GetDuration( _allowLoop );
                ...
                if(gen_param_count == 1) 
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetDuration(  );
                        LuaAPI.lua_pushnumber(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.ParticleSystem.GetDuration!");

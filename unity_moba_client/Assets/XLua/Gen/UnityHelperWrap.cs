...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityHelperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityHelper);
        ...
        {
            return LuaAPI.luaL_error(L, "UnityHelper does not have a constructor!");
        }
        ...
        static int _m_RaycastNonAlloc_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    int _mask = LuaAPI.xlua_tointeger(L, 4);
                    int _num = LuaAPI.xlua_tointeger(L, 5);
                    
                        var gen_ret = UnityHelper.RaycastNonAlloc( _origin, _direction, _maxDistance, _mask, _num );
        ...
        static int _m_SetLayer_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityHelper.SetLayer( _gameObject, _layer );

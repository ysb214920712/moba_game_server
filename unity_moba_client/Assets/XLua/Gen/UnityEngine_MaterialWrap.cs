...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineMaterialWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 59, 11, 10);
        ...
        static int _m_DOColor(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Color _endValue;translator.Get(L, 2, out _endValue);
                    int _propertyID = LuaAPI.xlua_tointeger(L, 3);
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                    
                        var gen_ret = gen_to_be_invoked.DOColor( _endValue, _propertyID, _duration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Color>(L, 2)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    UnityEngine.Color _endValue;translator.Get(L, 2, out _endValue);
                    string _property = LuaAPI.lua_tostring(L, 3);
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                    
                        var gen_ret = gen_to_be_invoked.DOColor( _endValue, _property, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        var gen_ret = gen_to_be_invoked.DOFade( _endValue, _propertyID, _duration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        var gen_ret = gen_to_be_invoked.DOFade( _endValue, _property, _duration );
                        translator.Push(L, gen_ret);
        ...
        static int _m_DOFloat(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        var gen_ret = gen_to_be_invoked.DOFloat( _endValue, _propertyID, _duration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        var gen_ret = gen_to_be_invoked.DOFloat( _endValue, _property, _duration );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Material.DOFloat!");
		    ...
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector2>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.DOOffset( _endValue, _duration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector2>(L, 2)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    UnityEngine.Vector2 _endValue;translator.Get(L, 2, out _endValue);
                    string _property = LuaAPI.lua_tostring(L, 3);
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                    
                        var gen_ret = gen_to_be_invoked.DOOffset( _endValue, _property, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector2>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.DOTiling( _endValue, _duration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector2>(L, 2)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        var gen_ret = gen_to_be_invoked.DOTiling( _endValue, _property, _duration );
                        translator.Push(L, gen_ret);
        ...
        static int _m_DOVector(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector4>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        var gen_ret = gen_to_be_invoked.DOVector( _endValue, _propertyID, _duration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector4>(L, 2)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    UnityEngine.Vector4 _endValue;translator.Get(L, 2, out _endValue);
                    string _property = LuaAPI.lua_tostring(L, 3);
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                    
                        var gen_ret = gen_to_be_invoked.DOVector( _endValue, _property, _duration );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Material.DOVector!");
		    ...
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Color>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        var gen_ret = gen_to_be_invoked.DOBlendableColor( _endValue, _propertyID, _duration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Color>(L, 2)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        var gen_ret = gen_to_be_invoked.DOBlendableColor( _endValue, _property, _duration );
                        translator.Push(L, gen_ret);

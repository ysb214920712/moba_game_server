...
namespace XLua.CSObjectWrap
{
    ...
    public class XORWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XOR);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XOR constructor!");
		    ...
		    try {
                ...
                
                {
                    ...
                    string _secretKey = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = XOR.decrypt( _content, _secretKey );
		    ...
		    try {
                ...
                
                {
                    ...
                    string _secretKey = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = XOR.encrypt( _content, _secretKey );
                        LuaAPI.lua_pushstring(L, gen_ret);

...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningCoreTweenerCore_3_UnityEngineVector3UnityEngineVector3DGTweeningPluginsOptionsVectorOptions_Wrap 
    {
        ...
        static int _m_SetInverted(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<UnityEngine.Vector3, UnityEngine.Vector3, DG.Tweening.Plugins.Options.VectorOptions>.SetInverted!");
		    ...
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _isRelative = LuaAPI.lua_toboolean(L, 4);
                        ...
                        var gen_ret = gen_to_be_invoked.From( _fromValue, _setImmediately, _isRelative );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool _setImmediately = LuaAPI.lua_toboolean(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.From( _fromValue, _setImmediately );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    float _fromValue = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.From( _fromValue );
                        translator.Push(L, gen_ret);
        ...
        static int _m_SetDelay(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<UnityEngine.Vector3, UnityEngine.Vector3, DG.Tweening.Plugins.Options.VectorOptions>.SetDelay!");

...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineCameraWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 48, 56, 43);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _sensorSize = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        var gen_ret = UnityEngine.Camera.FocalLengthToFOV( _focalLength, _sensorSize );
		    ...
		    try {
                ...
                
                {
                    ...
                    float _sensorSize = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        var gen_ret = UnityEngine.Camera.FOVToFocalLength( _fov, _sensorSize );
                        LuaAPI.lua_pushnumber(L, gen_ret);

        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new System.Collections.Generic.List<UnityEngine.Vector3>();
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					var gen_ret = new System.Collections.Generic.List<UnityEngine.Vector3>(_capacity);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.IEnumerable<UnityEngine.Vector3>>(L, 2))
				{
					...
					var gen_ret = new System.Collections.Generic.List<UnityEngine.Vector3>(_collection);
					translator.Push(L, gen_ret);

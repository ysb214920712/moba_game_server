...
namespace XLua.CSObjectWrap
{
    ...
    public class PrefsHelperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(PrefsHelper);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to PrefsHelper constructor!");
        ...
        static int _m_GetInt_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    ...
                    int _defaultValue = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = PrefsHelper.GetInt( _key, _defaultValue );
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _key = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = PrefsHelper.GetInt( _key );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to PrefsHelper.GetInt!");
        ...
        static int _m_SetInt_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    PrefsHelper.SetInt( _key, _value );
        ...
        static int _m_GetString_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _defaultValue = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = PrefsHelper.GetString( _key, _defaultValue );
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _key = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = PrefsHelper.GetString( _key );
                        LuaAPI.lua_pushstring(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to PrefsHelper.GetString!");
        ...
        static int _m_SetString_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    PrefsHelper.SetString( _key, _value );
